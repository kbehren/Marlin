...
#define STRING_CONFIG_H_AUTHOR "(kbehren, Layer Cake)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EAF
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Layer Cake"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Layer Cake - E3D Lite6
  #define DEFAULT_Kp 33.85
  #define DEFAULT_Ki 2.62
  #define DEFAULT_Kd 109.53
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 212.89 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 232.4 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 104.65 //mm  Get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 545.0 }
...
#define Z_PROBE_SPEED_FAST 8000
